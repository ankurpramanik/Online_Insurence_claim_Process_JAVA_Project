...
<script type="text/javascript"
	src="https://gc.kis.v2.scr.kaspersky-labs.com/CE49EB87-C050-BE4B-A5BA-D883233FF37A/main.js"
	charset="UTF-8"></script>
<link rel="stylesheet" crossorigin="anonymous"
	href="https://gc.kis.v2.scr.kaspersky-labs.com/A73FF332388D-AB5A-B4EB-050C-78BE94EC/abn/main.css" />
		...
		<div class="wrapper">
			<div class="col-md-4 col-md-offset-4 text-center">
				<div class="search-box">
					<form action="RegisterUser" class="loginForm">
						<div class="caption">
							<h3>Register Now</h3>
						</div>
						<div class="input-group">
							<input name="username" type="text" id="name" class="form-control"
								placeholder="Enter Username here..." required=""> <input
								name="password" type="password" id="paw" class="form-control"
								placeholder=" Enter Password here" required=""> <input
								type="submit" id="submit" class="form-control" value="Signup">
						</div>
						<div>
							<label>Already have an account?</label><a href="login.jsp">Login</a>
						</div>
					</form>
				</div>
			</div>
